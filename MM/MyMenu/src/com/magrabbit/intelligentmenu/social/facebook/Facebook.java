...
public class Facebook {
	...
	private String mAccountResource;
	...
	private void startDialogAuth(Activity activity, String[] permissions) {
		...
		dialog(activity, LOGIN, params, new DialogListener() {
			...
			public void onComplete(Bundle values) {
				...
				if (isSessionValid()) {
					Log.d("DEBUG", "Login Success! access_token="
			...
			public void onError(DialogError error) {
				Log.d("DEBUG", "Login failed: " + error);
	...
	public String getmAccountResource() {
		return mAccountResource;
	}

	public void setmAccountResource(String mAccountResource) {
		this.mAccountResource = mAccountResource;
	}
