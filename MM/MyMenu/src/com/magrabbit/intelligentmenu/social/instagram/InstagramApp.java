...
import com.magrabbit.intelligentmenu.social.instagram.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
	...
	private void getAccessToken(final String code) {
		mProgress.setMessage(mCtx.getString(R.string.mess_waitting));
		mProgress.show();
			...
			public void run() {
				...
				try {
					...
					String name = jsonObj.getJSONObject("user").getString(
							"full_name");
					String urlAvatar = jsonObj.getJSONObject("user").getString(
							"profile_picture");
