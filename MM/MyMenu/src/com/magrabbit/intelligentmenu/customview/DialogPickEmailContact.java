 ...
 * 
 */
public class DialogPickEmailContact extends BaseDialog implements
	 ...
	 * @param arrMenu
	 */
	public DialogPickEmailContact(Context context,
			PickContactListener listener, List<String> idContact,
			List<ContactObject> listContact, String fullName) {
		super(context);
		...
		mListContact.clear();
		mListContact.addAll(listContact);
		...
		mMyAdapter = new PickContactAdapter(mActivity, this.mListContact, true,
				this);
		...
		mLvContact.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				DialogEditContact dialog = new DialogEditContact(mActivity,
						DialogPickEmailContact.this, mListContact.get(position));
				dialog.show();
			}
		});
		searchWithFilter();
