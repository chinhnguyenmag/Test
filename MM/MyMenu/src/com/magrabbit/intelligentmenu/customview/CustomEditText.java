...
import com.magrabbit.intelligentmenu.listener.DrawableClickListener;
	...
	public boolean onTouchEvent(MotionEvent event) {
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			if (drawableLeft != null) {
				...
				if (x >= (this.getRight() - bounds.width() - fuzz)
						&& x <= (this.getRight() - this.getPaddingRight() + fuzz)
						&& y >= (this.getPaddingTop() - fuzz)
