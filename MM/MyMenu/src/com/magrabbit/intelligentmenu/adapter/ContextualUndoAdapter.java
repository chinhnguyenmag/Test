...
import com.magrabbit.intelligentmenu.customview.ContextualUndoView;
import com.magrabbit.intelligentmenu.listener.ContextualUndoListViewTouchListener;
...
//            animateViewComingBack();
        	int position = getAbsListView().getPositionForView(mContextualUndoView);
        	mDeleteItemCallback.deleteItem(position);
        }
