...
public class ViewPageAdapter extends PagerAdapter {
	...
	Context mContext;
	private List<String> mPhotosImages;
	private ImageLoader mImageLoader;
	private boolean mIsPortrait = true;

	public ViewPageAdapter(Activity context, List<String> photosImages,
			boolean portrait) {
		this.mContext = context;
		this.mPhotosImages = photosImages;
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		mImageLoader.DisplayImage(ServerURL.URL + mPhotosImages.get(position),
				imageView);
