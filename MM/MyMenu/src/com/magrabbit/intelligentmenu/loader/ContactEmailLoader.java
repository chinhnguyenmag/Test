...
public class ContactEmailLoader {
	...
	public ContactEmailLoader(Context context) {
	...
	// ContactObject tag = mContacts.get(photoToLoad.mContactObject);
	// if (tag == null
	...
	class BitmapDisplayer implements Runnable {
		...
		public void run() {
			if (number != null)
				photoToLoad.textView.setText(number);
			else {
				photoToLoad.textView.setText("");
			}
		}
	}
