...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	 ...
	 */
	public SwipeListViewTouchListener(ListView listView,
			OnSwipeCallback callback, boolean dismissLeft, boolean dismissRight) {
	...
	public SwipeListViewTouchListener(ListView listView,
			...
			boolean dismissRight, List<Integer> listItemOrder) {
		this(listView, callback);
		this.dismissLeft = dismissLeft;
		this.dismissRight = dismissRight;
		this.mListItemOrder = listItemOrder;
	}
...
//				if (mListItemOrder!=null&&mListItemOrder.size() != 0) {
//					for (int j = 0; j < mListItemOrder.size(); j++) {
//						if (mListItemOrder.get(j) != i) {
//							child = mListView.getChildAt(0);
//						}
//					}
//				}else{
...
//				}
		...
		case MotionEvent.ACTION_UP: {
			...
			if (deltaX < -50) {
				mVelocityTracker.addMovement(motionEvent);
				mVelocityTracker.computeCurrentVelocity(500); // 1000 by defaut
																// but
																// it was too
																// much
