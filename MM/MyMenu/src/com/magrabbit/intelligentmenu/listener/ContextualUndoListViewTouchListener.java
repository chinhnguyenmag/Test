...
/**
 * An OnTouchListener for the ContextualUndoAdapter. Don't use this class
 * directly, use ContextualUndoAdapter to wrap your BaseAdapters.
 */
public class ContextualUndoListViewTouchListener implements
	...
	public ContextualUndoListViewTouchListener(AbsListView listView,
			Callback callback) {
					...
					animate(mDownView)
							...
							.setListener(new AnimatorListenerAdapter() {
								...
								public void onAnimationEnd(Animator animation) {
									mCallback.onViewSwiped(downView,
											downPosition);
								}
							});
				} else {
